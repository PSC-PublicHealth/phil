...
class Global {
  public:
    ...
    */
    ...
    static bool Enable_Simple_Strain_Model;
...
/*
 * bitset big enough to store flags for MAX_NUM_SIMPLE_STRAINS
 */
typedef tiny_bitset<Global::MAX_NUM_SIMPLE_STRAINS> simple_strains_bitset;
